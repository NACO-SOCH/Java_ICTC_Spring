...
public class BeneficiaryReferralResource {
    ...
    @Autowired
    BeneficiaryReferralService beneficiaryReferralService;
    @Autowired
    BeneficiaryReferralQueryService beneficiaryReferralQueryService;
    
    
    
    @PostMapping("/beneficiary-referrals")
    public ResponseEntity<BeneficiaryReferralDTO> createBeneficiaryReferral(@Valid @RequestBody BeneficiaryReferralDTO beneficiaryReferralDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/beneficiary-referrals/" + result.getId())).body(result);
    }

    @PutMapping("/beneficiary-referrals")
    public ResponseEntity<BeneficiaryReferralDTO> updateBeneficiaryReferral(@Valid @RequestBody BeneficiaryReferralDTO beneficiaryReferralDTO) throws URISyntaxException {
    ...
    @GetMapping("/beneficiary-inward-referrals/advanced")
    public ResponseEntity<List<BeneficiaryReferral>> getAllBeneficiaryInwardReferralsAdvanced(BeneficiaryReferralCriteria criteria, Pageable pageable) {
        log.debug("REST request to get BeneficiaryReferrals by criteria: {}", criteria);
        Page<BeneficiaryReferral> page = beneficiaryReferralQueryService.findByCriteriaInward(criteria, pageable);
        return ResponseEntity.ok().body(page.getContent());
    }
    ...
    public ResponseEntity<Long> countBeneficiaryReferrals(BeneficiaryReferralCriteria criteria) {
        ...
        long count = beneficiaryReferralQueryService.countByCriteria(criteria);
    ...
    public ResponseEntity<BeneficiaryReferral> getBeneficiaryReferral(@PathVariable Long id) {
        ...
        Optional<BeneficiaryReferral> beneficiaryReferral = beneficiaryReferralService.find(id);
        return ResponseEntity.of(beneficiaryReferral);
    }
    ...
    public ResponseEntity<Void> declineBeneficiaryReferral(@PathVariable Long id) {
        log.debug("REST request to decline BeneficiaryReferral: {}", id);
        beneficiaryReferralService.declineBeneficiaryReferral(id);
        return ResponseEntity.ok().build();
    }

    @GetMapping("/beneficiary-referrals/referred/basic")
    public ResponseEntity<List<BeneficiaryReferral>> getAllBeneficiaryReferralsReferredBasic(BeneficiaryReferralCriteria criteria, Pageable pageable) {
        log.debug("REST request to get BeneficiaryReferrals by criteria: {}", criteria);
        Page<BeneficiaryReferral> page = beneficiaryReferralQueryService.findReferredBasic(criteria, pageable);
        return ResponseEntity.ok().body(page.getContent());
    }

    @GetMapping("/beneficiary-referrals/referred/advanced")
    public ResponseEntity<List<BeneficiaryReferral>> getAllBeneficiaryReferralsReferredAdvanced(BeneficiaryReferralCriteria criteria, Pageable pageable) {
        log.debug("REST request to get BeneficiaryReferrals by criteria: {}", criteria);
        Page<BeneficiaryReferral> page = beneficiaryReferralQueryService.findReferredAdvanced(criteria, pageable);
        return ResponseEntity.ok().body(page.getContent());
    }

    @GetMapping("/beneficiary-inward-referrals/basic")
    public ResponseEntity<List<BeneficiaryReferral>> getAllBeneficiaryInwardReferralsBasic(BeneficiaryReferralCriteria criteria, Pageable pageable) {
        log.debug("REST request to get BeneficiaryReferrals by criteria: {}", criteria);
        Page<BeneficiaryReferral> page = beneficiaryReferralQueryService.findByCriteriaInwardBasic(criteria, pageable);
        return ResponseEntity.ok().body(page.getContent());
    }
...
//
//	@GetMapping("/beneficiary-referrals/referred/basic")
//	public ResponseEntity<List<BeneficiaryReferral>> getAllBeneficiaryReferralsReferredBasic(
//			BeneficiaryReferralCriteria criteria, Pageable pageable) {
//		log.debug("REST request to get BeneficiaryReferrals by criteria: {}", criteria);
//		Page<BeneficiaryReferral> page = beneficiaryReferralQueryService.findReferredBasic(criteria, pageable);
...
//
//	@GetMapping("/beneficiary-referrals/referred/advanced")
//	public ResponseEntity<List<BeneficiaryReferral>> getAllBeneficiaryReferralsReferredAdvanced(
//			BeneficiaryReferralCriteria criteria, Pageable pageable) {
//		log.debug("REST request to get BeneficiaryReferrals by criteria: {}", criteria);
//		Page<BeneficiaryReferral> page = beneficiaryReferralQueryService.findReferredAdvanced(criteria, pageable);
//		HttpHeaders headers = PaginationUtil
...
//
//	@GetMapping("/beneficiary-inward-referrals/basic")
//	public ResponseEntity<List<BeneficiaryReferral>> getAllBeneficiaryInwardReferralsBasic(
//			BeneficiaryReferralCriteria criteria, Pageable pageable) {
//		log.debug("REST request to get BeneficiaryReferrals by criteria: {}", criteria);
//		Page<BeneficiaryReferral> page = beneficiaryReferralQueryService.findByCriteriaInwardBasic(criteria, pageable);
//		HttpHeaders headers = PaginationUtil
