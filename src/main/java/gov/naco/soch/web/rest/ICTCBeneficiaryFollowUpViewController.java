...
public class ICTCBeneficiaryFollowUpViewController {
    ...
    @Autowired
    ICTCBeneficiaryFollowUpViewService ictcBeneficiaryFollowUpViewService;
    @Autowired
    ICTCBeneficiaryFollowUpViewQueryService ictcBeneficiaryFollowUpViewQueryService;
    ...
    public ResponseEntity<ICTCBeneficiaryFollowUpViewDTO> getICTCBeneficiaryFollowup(@PathVariable Long id) {
        ...
        return iCTCBeneficiaryFollowupDTO.map(ResponseEntity::ok).orElse(ResponseEntity.notFound().build());
    }
