...
public class IctcRPQMappingResource {
    ...
    @Autowired
    IctcRPQMappingService ictcRPQMappingService;
    @Autowired
    IctcRPQMappingQueryService ictcRPQMappingQueryService;

    @PostMapping("/ictc-rpq-mappings")
    public ResponseEntity<IctcRPQMappingDTO> createIctcRPQMapping(@Valid @RequestBody IctcRPQMappingDTO ictcRPQMappingDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/ictc-rpq-mappings/" + result.getId())).body(result);
    }

    @PutMapping("/ictc-rpq-mappings")
    public ResponseEntity<IctcRPQMappingDTO> updateIctcRPQMapping(@Valid @RequestBody IctcRPQMappingDTO ictcRPQMappingDTO) throws URISyntaxException {
    ...
    public ResponseEntity<IctcRPQMappingDTO> getIctcRPQMapping(@PathVariable Long id) {
        ...
        return ResponseEntity.of(ictcRPQMappingDTO);
    }
