...
@RequestMapping("/api")
public class ICTCBatchDetailsResource {

    private final Logger log = LoggerFactory.getLogger(ICTCBatchDetailsResource.class);
...
//    private String applicationName;
    ...
    @PostMapping("/ictc-batch-details")
    public ResponseEntity<ICTCBatchDetailsDTO> createICTCBatchDetails(@RequestBody ICTCBatchDetailsDTO iCTCBatchDetailsDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/ictc-batch-details/" + result.getId()))
            .body(result);
    }

    @PutMapping("/ictc-batch-details")
    ...
    @GetMapping("/ictc-batch-details/basic")
    public ResponseEntity<List<ICTCBatchDetailsDTO>> getAllICTCBatchDetailsBasic(ICTCBatchDetailsCriteria criteria, Pageable pageable) {
        log.debug("REST request to get ICTCBatchDetails by criteria: {}", criteria);
        Page<ICTCBatchDetailsDTO> page = iCTCBatchDetailsQueryService.findByCriteria(criteria, pageable);
        return ResponseEntity.ok(page.getContent());
    }
    
    @GetMapping("/ictc-batch-details/advanced")
    public ResponseEntity<List<ICTCBatchDetailsDTO>> getAllICTCBatchDetailsAdvanced(ICTCBatchDetailsCriteria criteria, Pageable pageable) {
        log.debug("REST request to get ICTCBatchDetails by criteria: {}", criteria);
        Page<ICTCBatchDetailsDTO> page = iCTCBatchDetailsQueryService.findByCriteriaAdvanced(criteria, pageable);
        return ResponseEntity.ok(page.getContent());
    }

    @GetMapping("/ictc-batch-details/count")
    ...
    @GetMapping("/ictc-batch-details/{id}")
    ...
    @DeleteMapping("/ictc-batch-details/{id}")
...
//    /**
//     * {@code POST  /ictc-batch-details} : Create a new iCTCBatchDetails.
//     *
...
//
//    /**
//     * {@code PUT  /ictc-batch-details} : Updates an existing iCTCBatchDetails.
//     *
...
//
//    /**
//     * {@code GET  /ictc-batch-details} : get all the iCTCBatchDetails.
//     *
...
//    
//    @GetMapping("/ictc-batch-details/advanced")
//    public ResponseEntity<List<ICTCBatchDetailsDTO>> getAllICTCBatchDetailsBasicAdvanced(ICTCBatchDetailsCriteria criteria, Pageable pageable) {
//        log.debug("REST request to get ICTCBatchDetails by criteria: {}", criteria);
//        Page<ICTCBatchDetailsDTO> page = iCTCBatchDetailsQueryService.findByCriteriaAdvanced(criteria, pageable);
//        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(ServletUriComponentsBuilder.fromCurrentRequest(), page);
//        return ResponseEntity.ok().headers(headers).body(page.getContent());
...
//
//    /**
//     * {@code GET  /ictc-batch-details/count} : count all the iCTCBatchDetails.
//     *
//     * @param criteria the criteria which the requested entities should match.
...
//
//    /**
//     * {@code GET  /ictc-batch-details/:id} : get the "id" iCTCBatchDetails.
//     *
...
//    public ResponseEntity<ICTCBatchDetailsDTO> getICTCBatchDetails(@PathVariable Long id) {
//        log.debug("REST request to get ICTCBatchDetails : {}", id);
//        return ResponseEntity.ok().body(iCTCBatchDetailsService.getBatchDetails(id));
//    }
//
//    /**
//     * {@code DELETE  /ictc-batch-details/:id} : delete the "id" iCTCBatchDetails.
//     *
