...
public class RiskProfilingQuestionsResource {
    ...
    @Autowired
    RiskProfilingQuestionsService riskProfilingQuestionsService;
    @Autowired
    RiskProfilingQuestionsQueryService riskProfilingQuestionsQueryService;
    ...
    public ResponseEntity<RiskProfilingQuestionsDTO> getRiskProfilingQuestions(@PathVariable Long id) {
        ...
        return riskProfilingQuestionsDTO.map(ResponseEntity::ok).orElse(ResponseEntity.notFound().build());
    }
