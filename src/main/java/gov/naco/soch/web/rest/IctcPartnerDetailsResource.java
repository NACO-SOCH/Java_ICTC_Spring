...
public class IctcPartnerDetailsResource {
    ...
    @Autowired
    IctcPartnerDetailsService ictcPartnerDetailsService;
    ...
    public ResponseEntity<List<IctcPartnerDetails>> getAllIctcPartnerDetailsByBeneficiaryId(@PathVariable Long id) {
        log.debug("REST request to get a page of IctcPartnerDetails");
        List<IctcPartnerDetails> list = ictcPartnerDetailsService.findAllByBeneficiaryId(id);
    ...
    public ResponseEntity<IctcPartnerDetailsDTO> getIctcPartnerDetails(@PathVariable Long id) {
        ...
        return ResponseEntity.of(ictcPartnerDetailsDTO);
    }
