...
public class BeneficiaryFacilityMappingResource {
    ...
    @Autowired
    BeneficiaryFacilityMappingQueryService beneficiaryFacilityMappingQueryService;
...
//    }
    ...
    public ResponseEntity<BeneficiaryFacilityMappingDTO> createBeneficiaryFacilityMapping(@Valid @RequestBody BeneficiaryFacilityMappingDTO beneficiaryFacilityMappingDTO) throws URISyntaxException {
    ...
    public ResponseEntity<BeneficiaryFacilityMappingDTO> updateBeneficiaryFacilityMapping(@Valid @RequestBody BeneficiaryFacilityMappingDTO beneficiaryFacilityMappingDTO) throws URISyntaxException {
    ...
    public ResponseEntity<Page<BeneficiaryFacilityMappingDTO>> getAllBeneficiaryFacilityMappings(BeneficiaryFacilityMappingCriteria criteria, Pageable pageable) {
    ...
    public ResponseEntity<BeneficiaryFacilityMappingDTO> getBeneficiaryFacilityMapping(@PathVariable Long id) {
        ...
        if (beneficiaryFacilityMappingDTO.isPresent()) {
            return ResponseEntity.ok(beneficiaryFacilityMappingDTO.get());
        } else {
    ...
    public ResponseEntity<Page<BeneficiaryFacilityMapping>> getAllBeneficiaryFacilityMappingsAdvanced(BeneficiaryFacilityMappingCriteria criteria, Pageable pageable) {
        log.debug("REST request to get BeneficiaryFacilityMappings by criteria: {}", criteria);
    ...
    public ResponseEntity<Page<BeneficiaryFacilityMapping>> getAllBeneficiaryFacilityMappingsForArtBeneficiarySearch(BeneficiaryFacilityMappingCriteria criteria, Pageable pageable) {
        log.debug("REST request to get BeneficiaryFacilityMappings by criteria: {}", criteria);
