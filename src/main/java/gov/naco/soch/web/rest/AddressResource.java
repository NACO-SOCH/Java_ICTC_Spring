...
import gov.naco.soch.service.AddressQueryService;
...
/**
 * REST controller for managing {@link gov.naco.soch.domain.Address}.
 */
@RestController
...
public class AddressResource {
    ...
    private static final String ENTITY_NAME = "sochictcAddress";
...
//    private String applicationName;
    ...
    public ResponseEntity<AddressDTO> createAddress(@Valid @RequestBody AddressDTO addressDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(location)
                .header("X-" + ENTITY_NAME + "-created", result.getId().toString())
                .body(result);
    }
    ...
    public ResponseEntity<AddressDTO> updateAddress(@Valid @RequestBody AddressDTO addressDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
                .header("X-" + ENTITY_NAME + "-update", addressDTO.getId().toString())
                .body(result);
    }

    @GetMapping("/addresses")
    public ResponseEntity<Page<AddressDTO>> getAllAddresses(AddressCriteria criteria, Pageable pageable) {
