 ...
 */
@Entity
@Table(name = "ictc_beneficiary_counselling_view")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class ICTCBeneficiaryCounsellingView implements Serializable {
...
//	}
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ICTCBeneficiaryCounsellingView)) {
            return false;
        }
        return id != null && id.equals(((ICTCBeneficiaryCounsellingView) o).id);
    }
	...
	public String toString() {
		return "ICTCBeneficiaryCounsellingView [id=" + id + ", pid=" + pid + ", uid=" + uid + ", firstName=" + firstName
				...
				+ infantMotherBeneficiaryId + ", isPostTestCounsellingCompleted=" + isPostTestCounsellingCompleted
				+ ", hivStatusDesc=" + hivStatusDesc + ", beneficiaryStatusDesc=" + beneficiaryStatusDesc
				+ ", testTypeDesc=" + testTypeDesc + "]";
	}
