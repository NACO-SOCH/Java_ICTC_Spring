...
//    private String category;
	...
	public String toString() {
		return "ICTCSampleCollectionView [id=" + id + ", infantCode=" + infantCode + ", firstName=" + firstName
				...
				+ barcode + ", sampleCollectionDate=" + sampleCollectionDate + ", dateOfBirth=" + dateOfBirth
				+ ", batchId=" + batchId + ", resultStatus=" + resultStatus + ", facilityId=" + facilityId
				+ ", infantBreastFed=" + infantBreastFed + ", categoryId=" + categoryId + ", genderId=" + genderId
				+ ", testTypeDesc=" + testTypeDesc + ", sampleCollectionStatusDesc=" + sampleCollectionStatusDesc
				+ ", resultStatusDesc=" + resultStatusDesc + "]";
	}
