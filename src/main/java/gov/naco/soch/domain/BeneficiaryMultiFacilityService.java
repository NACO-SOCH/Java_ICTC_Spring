...
public class BeneficiaryMultiFacilityService extends Auditable<Long> implements Serializable {
	...
	public String toString() {
		return "BeneficiaryMultiFacilityService [id=" + id + ", beneficiaryId=" + beneficiaryId + ", ictcVisitId="
				...
				+ beneficiaryGlobalVisitId + ", isActive=" + isActive + ", isDeleted=" + isDeleted + "]";
	}
