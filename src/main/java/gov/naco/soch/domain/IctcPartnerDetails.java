...
public class IctcPartnerDetails extends Auditable<Long> implements Serializable {
    ...
    @JsonIgnoreProperties({"ictcBeneficiary", "facility", "visit", "sample"})
    @ManyToOne
    @JoinColumn(name = "follow_up_id")
    private ICTCFollowUp followUp;
	...
	public ICTCFollowUp getFollowUp() {
		return followUp;
	}

	public void setFollowUp(ICTCFollowUp followUp) {
