...
//    @Size(max = 25)
	...
	public String toString() {
		return "ICTCBeneficiaryFollowUpView [id=" + id + ", pid=" + pid + ", uid=" + uid + ", firstName=" + firstName
				...
				+ age + ", followUpDate=" + followUpDate + ", followUpType=" + followUpType + ", expectedDeliveryDate="
				+ expectedDeliveryDate + ", pregnancyLmpDate=" + pregnancyLmpDate + ", deliveryDate=" + deliveryDate
				+ ", isCompleted=" + isCompleted + ", beneficiaryStatus=" + beneficiaryStatus + ", beneficiaryId="
				+ beneficiaryId + ", visitId=" + visitId + ", testResultId=" + testResultId + ", ictcBeneficiaryId="
				+ ictcBeneficiaryId + ", facilityId=" + facilityId + ", visitDate=" + visitDate + ", dateOfBirth="
				+ dateOfBirth + ", categoryId=" + categoryId + ", genderId=" + genderId + ", beneficiaryStatusDesc="
				+ beneficiaryStatusDesc + ", transmissionRoute=" + transmissionRoute + "]";
	}
