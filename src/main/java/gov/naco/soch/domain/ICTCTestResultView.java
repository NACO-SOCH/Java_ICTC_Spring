...
//    private String category;
    ...
    @Column(name = "current_hiv_type")
    private Integer currentHivType;
    
    @Column(name = "sample_collected_lab_id")
    private Long sampleCollectedLabId;
    
    @Column(name = "test_type_desc")
    private String testTypeDesc;

    @Column(name = "hiv_status_desc")
    private String hivStatusDesc;
    
    @Column(name = "result_status_desc")
    private String resultStatusDesc;
    
    @Column(name = "sample_collection_status_desc")
    private String sampleCollectionStatusDesc;
    
    @Column(name = "batch_status_desc")
    private String batchStatusDesc;
    
    @Column(name = "hiv_type_desc")
	...
	public Integer getCurrentHivType() {
		return currentHivType;
	}

	public void setCurrentHivType(Integer currentHivType) {
		this.currentHivType = currentHivType;
	}
	
	public Long getSampleCollectedLabId() {
		return sampleCollectedLabId;
	}

	public void setSampleCollectedLabId(Long sampleCollectedLabId) {
		this.sampleCollectedLabId = sampleCollectedLabId;
	}
	...
	public String toString() {
		return "ICTCTestResultView [id=" + id + ", uid=" + uid + ", firstName=" + firstName + ", middleName="
				...
				+ hivStatus + ", hivType=" + hivType + ", testedDate=" + testedDate + ", sampleId=" + sampleId
				...
				+ ", sampleCollectionStatus=" + sampleCollectionStatus + ", batchStatus=" + batchStatus + ", referDate="
				+ referDate + ", followUpDate=" + followUpDate + ", artCenterName=" + artCenterName + ", artCenterCode="
				...
				+ barcode + ", infantCode=" + infantCode + ", currentHivStatus=" + currentHivStatus
				+ ", currentHivType=" + currentHivType + ", sampleCollectedLabId=" + sampleCollectedLabId
