...
public class ICTCBatchDetailsDTO implements Serializable {
	...
	public String toString() {
		return "ICTCBatchDetailsDTO [id=" + id + ", labId=" + labId + ", consignmentId=" + consignmentId
				...
				+ ", eidLabPincode=" + eidLabPincode + ", eidLabAddress=" + eidLabAddress + ", sampleCollectionDate="
				+ sampleCollectionDate + ", sampleReceivedDate=" + sampleReceivedDate + ", reportReceivedDate="
				+ reportReceivedDate + ", reportDeliveryDate=" + reportDeliveryDate + ", batchStatusDesc="
				+ batchStatusDesc + ", eidLabBatchDetails=" + eidLabBatchDetails + "]";
	}
