...
//    }
	...
	public String toString() {
		return "BeneficiaryDTO [id=" + id + ", uid=" + uid + ", aadharNumber=" + aadharNumber + ", age=" + age
				...
				+ ", isActive=" + isActive + ", isDelete=" + isDelete + ", addressId=" + addressId + ", hivTypeId="
				+ hivTypeId + ", hivStatusId=" + hivStatusId + ", occupationId=" + occupationId + ", monthlyIncomeId="
				...
				+ preArtNumber + ", pid=" + pid + ", tiCode=" + tiCode + ", ostCode=" + ostCode + ", maritalStatusId="
				+ maritalStatusId + "]";
	}
