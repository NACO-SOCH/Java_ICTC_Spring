...
public class IctcLinkedFacilityServiceImpl implements IctcLinkedFacilityService {
    ...
    @Transactional
    public List<IctcLinkedFacilityDTO> saveAll(List<IctcLinkedFacilityDTO> linkedFacilityDTOs, Long facilityId) {
        log.debug("Request to save IctcLinkedFacility : {}", linkedFacilityDTOs);
        ictcLinkedFacilityRepository.deleteIctcFacilityLinkings(facilityId);
        for(IctcLinkedFacilityDTO linkedFacility : linkedFacilityDTOs) {
        	save(linkedFacility);
        }
        return linkedFacilityDTOs;
    }
}
