...
public interface ICTCGeneralService {
	...
	ICTCBeneficiaryDO getICTCBeneficiaryDetails(Long ictcBeneficiaryId, Boolean isPregnant);
	...
	void attendAppointment(Long ictcBeneficiaryId, Long facilityId, Long appointmentId);
	
	Boolean getRegistrationBackDateStatus();
}
